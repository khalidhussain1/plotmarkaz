  ...
  <div class="container" style="min-width: 50%; background-color: transparent;">
    ...
    <?php if (isset($_GET['message'])) { ?>
      ...
      <div class="col-lg-6 col-sm-6 ">
        ...
        <form class="row justify-content-center" style=" padding: 30px 0px 30px 0px; border: 1px solid gray" action="login_submission.php" method="post">
          <div class="col-md-7">
            <h4 style="text-align: center; color: black;">LOG IN</h4><br>
          </div>
          <div class="col-md-7">
            Email:
            <input type="email" class="form-control" id="inputemail" placeholder="" name="email"><br>
          </div><br>
          <div class="col-md-7">
            Password:
            <input type="password" class="form-control" id="inputPhoneno" placeholder="" name="password">
            <br>
          </div>
          <br>
          <div class="col-7 d-flex justify-content-center">
            <button style="width: 80%;" type="submit" class="btn btn-secondary">LOG IN</button><br><br>
          </div>
          <br>
          <center>Don't have an account yet?<a href="signup.php">Sign up</a></center>
        </form>
      </div>
    </div>
